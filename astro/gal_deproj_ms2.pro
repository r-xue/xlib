...
foreach ind,gselect do begin
  ...
  ; HEX SAMPLING
  temp=fitsloc+subtypes[select_ref].prefix+galno+subtypes[select_ref].posfix+'_smo'+ores+dp+'.fits'
  print,temp
  ...
  foreach type, subtypes do begin
    fname=fitsloc+type.prefix+galno+type.posfix+'_smo'+ores+dp+'.fits'
    fnamemsk=fitsloc+type.prefix+galno+type.posfix+'_mskd_smo'+ores+dp+'.fits'

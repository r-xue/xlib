PRO FXREADX, FILENAME, DATA, HEADER, P1, P2, P3, P4, P5,     $
    ...
    ALT=ALT
;++
;   this is basically fxread, but output a correct subimage header
...
;+
;   FIX HEADER BY BORROWING CODES FROM HEXTRACT
;-

;++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
naxis1 = p2 - p1 + 1
naxis2 = p4 - p3 + 1   ;New dimensions
...
if ( Ncnpix1 EQ 1 ) then begin   ;Shift position of reference pixel
    sxaddpar, newhd, 'CNPIX1', cnpix1+p1
    cnpix2 = sxpar( oldhd, 'CNPIX2' )
    sxaddpar, newhd, 'CNPIX2', cnpix2+p3
endif
...
if noparams GE 0 then begin
    ...
    if astr.projection EQ 'SFL' then begin
        ...
        sxaddpar,newhd,'CRPIX1'+alt,crpix[0]-p1
        sxaddpar,newhd,'CRPIX2'+alt,crpix[1]-p3
    endif else begin
        sxaddpar, newhd, 'CRPIX1'+alt, astr.crpix[0]-p1
        sxaddpar, newhd, 'CRPIX2'+alt, astr.crpix[1]-p3
    endelse
endif

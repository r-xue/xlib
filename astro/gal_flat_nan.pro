FUNCTION GAL_FLAT_NAN,IMAGE,ANG,INC,CEN,INTERP = interp
;!!!
;       This is just a slightly modified gal_flat.pro
;       20130410  RX use !values.f_nan for missing data  
;!!!
;+
; NAME:
;	GAL_FLAT
...
;                                    Do it
  ...
  RETURN,poly_2d( image, kx, ky, interp, MISSING = !values.f_nan)
  end  

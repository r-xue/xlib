pro plot_lineid,wave,flux,wline,text1,text2, extend=extend, $
	lcharthick = lcharthick,lcharsize=lcharsize,window=window, $
	lcolor=lcolor, $
	 _EXTRA = extra
!except=2
;+
;   this is a modified version of lineid_plot with option to change the text colors
;-
;+
; NAME:
;	LINEID_PLOT
